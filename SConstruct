...
SConscript(applications, exports='envapplications')
components = os.path.join('components','SConscript')
SConscript(components, exports='envcomponents')
defaults = os.path.join('defaults','SConscript')
SConscript(defaults, exports='env')
library = os.path.join('library','SConscript')
SConscript(library, exports='env')
contrib = os.path.join('contrib','SConscript')
SConscript(contrib, exports='env')
